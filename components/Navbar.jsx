...
export const Navbar = () => {
  ...
  return (
    <>
      <nav className="header h-20 bg-[#1F1F1F] flex items-center md:justify-between">
        <Link href="/">
        ...
        >
          ...
          <div className="text-black z-20 md:text-white flex flex-col absolute m-0 w-64 right-0 top-[40px] md:block md:static md:m-auto md:w-full md:h-full h-screen bg-slate-300 rounded-2xl md:bg-transparent">
            <Link href="/">
